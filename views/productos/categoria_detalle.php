        ...
        <div class="container-fluid p-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a class="text-danger" href="categoria_catalogo.php">Categorias</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Detalle - Categoria 1</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="container-fluid pb-4 pl-4 pr-4">
            ...
            <div class="row justify-content-center p-1">
                <div class="col-md-12"> 
                    ...
                    <a href="" class="btn btn-danger float-right btn-sm mb-2" data-toggle="modal" data-target="#nuevoProducto">Agregar Sub Categoria</a>
                    <a href="" class="btn btn-danger float-right btn-sm mb-2 mr-1" data-toggle="modal" data-target="#nuevoProducto">Editar Categoria</a>
